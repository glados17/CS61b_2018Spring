...
public class LinkedListDequeNoSen<LochNess> {
...
/** a way without sentinel*/
    ...
    public LinkedListDequeNoSen(LochNess x){
        first = new StuffNode(x, null, null);
        size = 1;
        last = first;
    }

    public LinkedListDequeNoSen(){
        first = null;
        size = 0;
        last = first;
    }
...
//        System.out.println(res);
    ...
    public static LinkedListDequeNoSen of(Integer... args){
        LinkedListDequeNoSen result, p;
        if (args.length > 0) {
            result = new LinkedListDequeNoSen(args[0]);
        } else {
            result = new LinkedListDequeNoSen();
            return null;
        }
        int k;
